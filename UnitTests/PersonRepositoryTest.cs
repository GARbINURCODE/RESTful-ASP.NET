...
namespace UnitTests
{
    public class PersonRepositoryTest
    {
        ...
        public void DeleteTest()
        {
            ...
            var testHelper = new TestHelper();
            var personRepository = testHelper.PersonRepository;
            var person = personRepository.GetByIdAsync(Guid.Parse("{6EF28B9F-A4C9-4E36-A74E-7E00B0FC029E}")).Result;
            personRepository.ChangeTrackerClear();
            ...
            //Assert
            Assert.Equal(1, personRepository.GetByIdAsync(Guid.Parse("{6EF28B9F-A4C9-4E36-A74E-7E00B0FC029E}")).Result.Orders.Count);
        }
    }
}
